...
def execute():
    try:
        items = get_contractor_items(None, "", None, 0, 20, {"contractor": "Nitin"}) # Try any contractor you know exists or just query directly
        print(items)
        ...
        if conts:
            items = get_contractor_items(None, "", None, 0, 20, {"contractor": conts[0][0]})
            print("Items:", items)

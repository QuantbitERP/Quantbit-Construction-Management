...
def on_update(doc, method):
    ...
    try:
        tender = frappe.get_doc({
            ...
            "tender_fees_exempted": doc.custom_tender_fee_exempted,
            "tender_fees": doc.custom_tender_fee,
            ...
            "scope_of_work": doc.custom_scope_of_work_,
...
def create_tender_from_opportunity(opportunity_name, tender_name):
    ...
    tender = frappe.get_doc({
        ...
        "tender_fees_exempted": opportunity_doc.custom_tender_fee_exempted,
        "tender_fees": opportunity_doc.custom_tender_fee,
        ...
        "scope_of_work": opportunity_doc.custom_scope_of_work_,
